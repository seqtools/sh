...
curl --progress-bar -L --cookie /tmp/cookie.txt --cookie-jar /tmp/cookie.txt $LINK -o Homo_sapiens_${1}_${2}.tar.gz
...
case $1 in
	...
	"NCBI_GRCh38")
		...
		mkdir -p ./NCBI_GRCh38
		cd ./NCBI_GRCh38
		curl --progress-bar -L -o common_all_20160527.vcf.gz.tbi -C - ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh38p2/VCF/GATK/common_all_20160527.vcf.gz.tbi
		(echo Step 2; date) | sed 'N;s/\n/ /'
		curl --progress-bar -L -o common_all_20160527.vcf.gz -C - ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh38p2/VCF/GATK/common_all_20160527.vcf.gz
