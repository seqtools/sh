...
curl --load-cookie /tmp/cookie.txt --save-cookie /tmp/cookie.txt $LINK -O Homo_sapiens_${1}_${2}.tar.gz
...
case $1 in
	"Ensembl_GRCh37") 
		...
		(curl -c -O common_all_20160601.vcf.gz.tbi ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh37p13/VCF/common_all_20160601.vcf.gz.tbi)
		(echo Step 3 dbSNP_vcf; date) | sed 'N;s/\n/ /'
		(curl -c -O common_all_20160601.vcf.gz ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh37p13/VCF/common_all_20160601.vcf.gz)
	...
	"NCBI_GRCh38")
		...
		cd ./NCBI_GRCh38
		(echo Step 2 dbSNP_tbi; date) | sed 'N;s/\n/ /'
		(curl -c -O common_all_20160527.vcf.gz.tbi ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh38p2/VCF/GATK/common_all_20160527.vcf.gz.tbi)
		(echo Step 3 dbSNP_vcf; date) | sed 'N;s/\n/ /'
		(curl -c -O common_all_20160527.vcf.gz ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh38p2/VCF/GATK/common_all_20160527.vcf.gz)
	...
	"UCSC_hg19") 
		...
		cd ./UCSC_hg19
		(echo Step 2 dbSNP_tbi; date) | sed 'N;s/\n/ /'
		(curl -c -O common_all_20160601.vcf.gz.tbi ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh37p13/VCF/GATK/common_all_20160601.vcf.gz.tbi)
		(echo Step 3 dbSNP_vcf; date) | sed 'N;s/\n/ /'
		(curl -c -O common_all_20160601.vcf.gz ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b147_GRCh37p13/VCF/GATK/common_all_20160601.vcf.gz)
		(checkfile common_all_20160601.vcf.gz) 
		(checkfile common_all_20160601.vcf.gz.tbi) 
		cd ../..
